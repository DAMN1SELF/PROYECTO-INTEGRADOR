package com.utp.grupo3.proyecto_integrador;
...
public class MainPrueba extends JFrame implements ActionListener {
	...
	public MainPrueba() {
		...
		setResizable(false);
		//setTitle("Mendo Paz SRL � Soluci�n Proyecto AED 2021 I � " + Fecha.fecha());
